...
Here is what you need to do:
 ...
 (2) You should do Group B Problem 1, and your partner should do
     Group A Problem 1. When you are both finished writing your
 ...
 (3) Now that you have practice developing a simple algorithm, do
     Group B Problem 2. When you and your partner are both finished,
